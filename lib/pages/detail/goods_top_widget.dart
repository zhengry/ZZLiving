...
class GoodsTopWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: _goodsImage(goodsInfo.image1, goodsInfo.goodsName, goodsInfo.presentPrice,goodsInfo.oriPrice),
    );
  }

  Widget _goodsImage(String imageUrl,String name,double price,double marketPrice){
    return Container(
          ...
          Container(
            child: Row(
              children: <Widget>[
                ...
                SizedBox(width: 10),
                Text('市场价：￥$marketPrice',style: TextStyle(color: Colors.black45))
              ],
            ),
          )
        ],
